...
def parse_arguments():
    ...
    parser.add_argument('--input', '--input_multitrack', 
                        help="Location of saved .npz Multitrack file")
...
def setup():
    ...
    # Create Multitrack file from given path
    midi = Multitrack(args.input)

    return params, config, midi

def main():
    """Main function."""
    # Setup
    logging.basicConfig(level=LOGLEVEL, format=LOG_FORMAT)
    params, config, midi = setup()
